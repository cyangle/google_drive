...
module GoogleDrive
  class ApiClient
    ...
    def build_api_request(http_method : Symbol, path : String, operation : String, post_body : String?, auth_names = [] of String, header_params = {} of String => String, query_params = {} of String => String, form_params = {} of String => (String | Array(String) | ::File)) : Crest::Request
      # ssl_options = {
