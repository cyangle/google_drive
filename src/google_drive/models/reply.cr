...
module GoogleDrive
  ...
  class Reply
    ...
    @[JSON::Field(key: "action", type: String?, presence: true, ignore_serialize: action.nil? && !action_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "kind", type: String?, default: "drive#reply", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
