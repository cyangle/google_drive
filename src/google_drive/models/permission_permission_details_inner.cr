...
module GoogleDrive
  class PermissionPermissionDetailsInner
    ...
    @[JSON::Field(key: "permissionType", type: String?, presence: true, ignore_serialize: permission_type.nil? && !permission_type_present?, emit_null: true)]
    ...
    def hash
      [inherited, inherited_from, permission_type, role].hash
    end
