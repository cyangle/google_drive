...
require "./drive_background_image_file"
require "./drive_capabilities"
require "./drive_restrictions"
...
module GoogleDrive
  ...
  class Drive
    ...
    @[JSON::Field(key: "backgroundImageFile", type: GoogleDrive::DriveBackgroundImageFile?, default: nil, required: false, nullable: false, emit_null: false)]
    getter background_image_file : GoogleDrive::DriveBackgroundImageFile? = nil
    ...
    @[JSON::Field(key: "capabilities", type: GoogleDrive::DriveCapabilities?, default: nil, required: false, nullable: false, emit_null: false)]
    getter capabilities : GoogleDrive::DriveCapabilities? = nil
    ...
    @[JSON::Field(key: "hidden", type: Bool?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "kind", type: String?, default: "drive#drive", required: false, nullable: false, emit_null: false)]
    getter kind : String? = "drive#drive"
    ...
    @[JSON::Field(key: "restrictions", type: GoogleDrive::DriveRestrictions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter restrictions : GoogleDrive::DriveRestrictions? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @background_image_file : GoogleDrive::DriveBackgroundImageFile? = nil,
      @background_image_link : String? = nil,
      @capabilities : GoogleDrive::DriveCapabilities? = nil,
    ...
    def_equals_and_hash(@background_image_file, @background_image_link, @capabilities, @color_rgb, @created_time, @hidden, @id, @kind, @name, @org_unit_id, @restrictions, @theme_id)
  end
end
