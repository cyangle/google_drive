...
module GoogleDrive
  ...
  class TeamDrive
    ...
    # Optional properties
    @[NASON::Field(key: "backgroundImageFile", type: TeamDriveBackgroundImageFile?, nillable: true)]
    ...
    @[NASON::Field(key: "capabilities", type: TeamDriveCapabilities?, nillable: true)]
    ...
    @[NASON::Field(key: "kind", type: String?, default: "drive#teamDrive", nillable: true)]
    ...
    @[NASON::Field(key: "restrictions", type: TeamDriveRestrictions?, nillable: true)]
