...
module GoogleDrive
  ...
  class TeamDrive
    ...
    @[JSON::Field(key: "capabilities", type: TeamDriveCapabilities?, presence: true, ignore_serialize: capabilities.nil? && !capabilities_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "kind", type: String?, default: "drive#teamDrive", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "restrictions", type: TeamDriveRestrictions?, presence: true, ignore_serialize: restrictions.nil? && !restrictions_present?, emit_null: true)]
