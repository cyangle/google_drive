...
module GoogleDrive
  ...
  class Revision
    ...
    @[JSON::Field(key: "keepForever", type: Bool?, presence: true, ignore_serialize: keep_forever.nil? && !keep_forever_present?, emit_null: true)]
    property keep_forever : Bool?
    @[JSON::Field(ignore: true)]
    property? keep_forever_present : Bool = false

    # Identifies what kind of resource this is. Value: the fixed string \"drive#revision\".
    @[JSON::Field(key: "kind", type: String?, default: "drive#revision", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "publishAuto", type: Bool?, presence: true, ignore_serialize: publish_auto.nil? && !publish_auto_present?, emit_null: true)]
    property publish_auto : Bool?
    @[JSON::Field(ignore: true)]
    property? publish_auto_present : Bool = false

    # Whether this revision is published. This is only applicable to Docs Editors files.
    @[JSON::Field(key: "published", type: Bool?, presence: true, ignore_serialize: published.nil? && !published_present?, emit_null: true)]
    property published : Bool?
    @[JSON::Field(ignore: true)]
    property? published_present : Bool = false

    # A link to the published revision. This is only populated for Google Sites files.
    @[JSON::Field(key: "publishedLink", type: String?, presence: true, ignore_serialize: published_link.nil? && !published_link_present?, emit_null: true)]
    property published_link : String?
    @[JSON::Field(ignore: true)]
    property? published_link_present : Bool = false

    # Whether this revision is published outside the domain. This is only applicable to Docs Editors files.
    @[JSON::Field(key: "publishedOutsideDomain", type: Bool?, presence: true, ignore_serialize: published_outside_domain.nil? && !published_outside_domain_present?, emit_null: true)]
