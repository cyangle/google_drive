...
module GoogleDrive
  ...
  class CommentList
    ...
    @[JSON::Field(key: "comments", type: Array(Comment)?, presence: true, ignore_serialize: comments.nil? && !comments_present?, emit_null: true)]
    property comments : Array(Comment)?
    @[JSON::Field(ignore: true)]
    property? comments_present : Bool = false

    # Identifies what kind of resource this is. Value: the fixed string \"drive#commentList\".
    @[JSON::Field(key: "kind", type: String?, default: "drive#commentList", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    ...
    def hash
      [comments, kind, next_page_token].hash
    end
