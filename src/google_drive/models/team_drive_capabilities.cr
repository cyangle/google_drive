...
module GoogleDrive
  ...
  class TeamDriveCapabilities
    ...
    @[JSON::Field(key: "canChangeTeamDriveBackground", type: Bool?, presence: true, ignore_serialize: can_change_team_drive_background.nil? && !can_change_team_drive_background_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "canChangeTeamMembersOnlyRestriction", type: Bool?, presence: true, ignore_serialize: can_change_team_members_only_restriction.nil? && !can_change_team_members_only_restriction_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "canDeleteTeamDrive", type: Bool?, presence: true, ignore_serialize: can_delete_team_drive.nil? && !can_delete_team_drive_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "canRenameTeamDrive", type: Bool?, presence: true, ignore_serialize: can_rename_team_drive.nil? && !can_rename_team_drive_present?, emit_null: true)]
