...
module GoogleDrive
  class PermissionTeamDrivePermissionDetails
    ...
    @[NASON::Field(key: "inherited", type: Bool?, nillable: true)]
    property inherited : Bool?

    # Deprecated - use permissionDetails/inheritedFrom instead.
    @[NASON::Field(key: "inheritedFrom", type: String?, nillable: true)]
    ...
    @[NASON::Field(key: "teamDrivePermissionType", type: String?, nillable: true)]
