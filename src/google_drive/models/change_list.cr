...
module GoogleDrive
  ...
  class ChangeList
    ...
    @[JSON::Field(key: "changes", type: Array(Change)?, presence: true, ignore_serialize: changes.nil? && !changes_present?, emit_null: true)]
    property changes : Array(Change)?
    @[JSON::Field(ignore: true)]
    property? changes_present : Bool = false

    # Identifies what kind of resource this is. Value: the fixed string \"drive#changeList\".
    @[JSON::Field(key: "kind", type: String?, default: "drive#changeList", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    property kind : String?
    @[JSON::Field(ignore: true)]
    property? kind_present : Bool = false

    # The starting page token for future changes. This will be present only if the end of the current changes list has been reached.
    @[JSON::Field(key: "newStartPageToken", type: String?, presence: true, ignore_serialize: new_start_page_token.nil? && !new_start_page_token_present?, emit_null: true)]
    ...
    def hash
      [changes, kind, new_start_page_token, next_page_token].hash
    end
