...
module GoogleDrive
  ...
  class DriveBackgroundImageFile
    ...
    @[JSON::Field(key: "width", type: Float32?, presence: true, ignore_serialize: width.nil? && !width_present?, emit_null: true)]
    property width : Float32?
    @[JSON::Field(ignore: true)]
    property? width_present : Bool = false

    # The X coordinate of the upper left corner of the cropping area in the background image. This is a value in the closed range of 0 to 1. This value represents the horizontal distance from the left side of the entire image to the left side of the cropping area divided by the width of the entire image.
    @[JSON::Field(key: "xCoordinate", type: Float32?, presence: true, ignore_serialize: x_coordinate.nil? && !x_coordinate_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "yCoordinate", type: Float32?, presence: true, ignore_serialize: y_coordinate.nil? && !y_coordinate_present?, emit_null: true)]
    ...
    def hash
      [id, width, x_coordinate, y_coordinate].hash
    end
