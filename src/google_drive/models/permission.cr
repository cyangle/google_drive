...
module GoogleDrive
  ...
  class Permission
    ...
    @[JSON::Field(key: "allowFileDiscovery", type: Bool?, presence: true, ignore_serialize: allow_file_discovery.nil? && !allow_file_discovery_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "displayName", type: String?, presence: true, ignore_serialize: display_name.nil? && !display_name_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "emailAddress", type: String?, presence: true, ignore_serialize: email_address.nil? && !email_address_present?, emit_null: true)]
    property email_address : String?
    @[JSON::Field(ignore: true)]
    property? email_address_present : Bool = false

    # The time at which this permission will expire (RFC 3339 date-time). Expiration times have the following restrictions:   - They can only be set on user and group permissions  - The time must be in the future  - The time cannot be more than a year in the future
    @[JSON::Field(key: "expirationTime", type: Time?, converter: Time::RFC3339Converter, presence: true, ignore_serialize: expiration_time.nil? && !expiration_time_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "kind", type: String?, default: "drive#permission", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    property kind : String?
    @[JSON::Field(ignore: true)]
    property? kind_present : Bool = false

    # Details of whether the permissions on this shared drive item are inherited or directly on this item. This is an output-only field which is present only for shared drive items.
    @[JSON::Field(key: "permissionDetails", type: Array(PermissionPermissionDetailsInner)?, presence: true, ignore_serialize: permission_details.nil? && !permission_details_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "photoLink", type: String?, presence: true, ignore_serialize: photo_link.nil? && !photo_link_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "teamDrivePermissionDetails", type: Array(PermissionTeamDrivePermissionDetailsInner)?, presence: true, ignore_serialize: team_drive_permission_details.nil? && !team_drive_permission_details_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "view", type: String?, presence: true, ignore_serialize: view.nil? && !view_present?, emit_null: true)]
