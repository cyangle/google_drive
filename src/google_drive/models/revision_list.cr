...
module GoogleDrive
  ...
  class RevisionList
    ...
    @[JSON::Field(key: "kind", type: String?, default: "drive#revisionList", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "revisions", type: Array(Revision)?, presence: true, ignore_serialize: revisions.nil? && !revisions_present?, emit_null: true)]
    ...
    def hash
      [kind, next_page_token, revisions].hash
    end
