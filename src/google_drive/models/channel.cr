...
module GoogleDrive
  ...
  class Channel
    ...
    @[JSON::Field(key: "address", type: String?, presence: true, ignore_serialize: address.nil? && !address_present?, emit_null: true)]
    property address : String?
    @[JSON::Field(ignore: true)]
    property? address_present : Bool = false

    # Date and time of notification channel expiration, expressed as a Unix timestamp, in milliseconds. Optional.
    @[JSON::Field(key: "expiration", type: String?, presence: true, ignore_serialize: expiration.nil? && !expiration_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "kind", type: String?, default: "api#channel", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    property kind : String?
    @[JSON::Field(ignore: true)]
    property? kind_present : Bool = false

    # Additional parameters controlling delivery channel behavior. Optional.
    @[JSON::Field(key: "params", type: Hash(String, String)?, presence: true, ignore_serialize: params.nil? && !params_present?, emit_null: true)]
    property params : Hash(String, String)?
    @[JSON::Field(ignore: true)]
    property? params_present : Bool = false

    # A Boolean value to indicate whether payload is wanted. Optional.
    @[JSON::Field(key: "payload", type: Bool?, presence: true, ignore_serialize: payload.nil? && !payload_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "resourceUri", type: String?, presence: true, ignore_serialize: resource_uri.nil? && !resource_uri_present?, emit_null: true)]
    property resource_uri : String?
    @[JSON::Field(ignore: true)]
    property? resource_uri_present : Bool = false

    # An arbitrary string delivered to the target address with each notification delivered over this channel. Optional.
    @[JSON::Field(key: "token", type: String?, presence: true, ignore_serialize: token.nil? && !token_present?, emit_null: true)]
