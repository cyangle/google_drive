...
module GoogleDrive
  ...
  class DriveList
    ...
    @[NASON::Field(key: "drives", type: Array(Drive)?, nillable: true)]
    property drives : Array(Drive)?

    # Identifies what kind of resource this is. Value: the fixed string \"drive#driveList\".
    @[NASON::Field(key: "kind", type: String?, default: "drive#driveList", nillable: true)]
    ...
    def initialize(*, @drives : Array(Drive)? = nil, @kind : String? = "drive#driveList", @next_page_token : String? = nil)
    end
    ...
    def hash
      [drives, kind, next_page_token].hash
    end
