...
module GoogleDrive
  ...
  class FileShortcutDetails
    ...
    @[NASON::Field(key: "targetId", type: String?, nillable: true)]
    ...
    @[NASON::Field(key: "targetMimeType", type: String?, nillable: true)]
    property target_mime_type : String?

    # The ResourceKey for the target file.
    @[NASON::Field(key: "targetResourceKey", type: String?, nillable: true)]
