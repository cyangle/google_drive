...
module GoogleDrive
  ...
  class DriveRestrictions
    ...
    @[NASON::Field(key: "adminManagedRestrictions", type: Bool?, nillable: true)]
    ...
    @[NASON::Field(key: "domainUsersOnly", type: Bool?, nillable: true)]
    property domain_users_only : Bool?

    # Whether access to items inside this shared drive is restricted to its members.
    @[NASON::Field(key: "driveMembersOnly", type: Bool?, nillable: true)]
    ...
    def hash
      [admin_managed_restrictions, copy_requires_writer_permission, domain_users_only, drive_members_only].hash
    end
