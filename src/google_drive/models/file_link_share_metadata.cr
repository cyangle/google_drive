...
module GoogleDrive
  ...
  class FileLinkShareMetadata
    ...
    @[NASON::Field(key: "securityUpdateEligible", type: Bool?, nillable: true)]
    property security_update_eligible : Bool?

    # Whether the security update is enabled for this file.
    @[NASON::Field(key: "securityUpdateEnabled", type: Bool?, nillable: true)]
    ...
    def hash
      [security_update_eligible, security_update_enabled].hash
    end
